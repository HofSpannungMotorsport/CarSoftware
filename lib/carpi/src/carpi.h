...
#define CARPI_VERSION "V0.1.6-C-ASR"
...
#include "components/interface/IDisplay.h"
...
public:
    ...
    {
#ifdef USE_ARDUINO
        pcSerial.print("Carpi Version: ");
        pcSerial.println(_version.c_str());
        pcSerial.print("Environment: ");
        pcSerial.println(_environment.c_str());
#endif
