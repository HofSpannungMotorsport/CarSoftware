...
void FixedCalibrationMeasurement() {
    wait(0.3);
    printf("FixedCalibrationMeasurement\n\nStarting with Calibration in 5 \t");
    wait(1);
    ...
    printf("Starting Calibration for %i seconds!\n", CALIBRATION_TIME);
